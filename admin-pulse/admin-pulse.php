...
class FFL_Admin_Theme_Pulse {
	...
	function init(){
		...
		$arg = array(
		     'page_title'   => 'Pulse Admin Theme'
		    ,'menu_title'	=> 'Pulse Admin'
		    ,'menu_slug'	=> 'admin-pulse'
		    ,'setting_name' => 'admin_theme_pulse_option'
